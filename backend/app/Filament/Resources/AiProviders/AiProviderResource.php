...
class AiProviderResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Configuración HCS';

    protected static ?string $modelLabel = 'Agente LLM';

    protected static ?string $pluralModelLabel = 'Agentes LLM';
